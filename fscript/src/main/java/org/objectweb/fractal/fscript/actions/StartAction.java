...
import org.objectweb.fractal.fscript.reconfiguration.StartReconfiguration;

/**
 * @author Pierre-Charles David <pcdavid@gmail.com>
 */
public class StartAction extends AbstractProcedure {
    ...
    public Object apply(Object[] args) throws ScriptExecutionError {
        ...
        return new StartReconfiguration(cn.getComponent()).apply();
    }
}
