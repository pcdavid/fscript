...
import org.objectweb.fractal.fscript.reconfiguration.StopReconfiguration;

/**
 * @author Pierre-Charles David <pcdavid@gmail.com>
 */
public class StopAction extends AbstractProcedure {
    ...
    public Object apply(Object[] args) throws ScriptExecutionError {
        ...
        return new StopReconfiguration(cn.getComponent()).apply();
    }
}
