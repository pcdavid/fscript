...
/**
 * This function computes the difference of its nodesets arguments. It takes exactly two
 * nodeset arguments, and returns a new nodeset which includes the nodes which appear in
 * this first argument but not in the second. All the nodes present in the arguments must
 * be of the same kind.
 * 
...
public class DifferenceFunction extends AbstractProcedure {
    ...
    protected Object apply(Object[] args) throws ScriptExecutionError {
        ...
        result.removeAll(typedArgument(args[1], Set.class));
        return result;
    }
}
