...
/**
 * Tests whether an interface is client or server. This procedure takes exactly one
 * argument, which must be an interface node, are returns <code>true</code> if the
 * corresponding component interface is a client interface, and <code>false</code> if it
 * is a server interface.
 * 
 * @author Pierre-Charles David <pcdavid@gmail.com>
 */
public class ClientFunction extends AbstractProcedure {
