...
/**
 * Tests whether an interface is collection or single. This procedure takes exactly one
 * argument, which must be an interface node, are returns <code>true</code> if the
 * corresponding component interface is a collection interface, and <code>false</code>
 * if it is a single interface.
 * 
 * @author Pierre-Charles David <pcdavid@gmail.com>
 */
public class CollectionItfFunction extends AbstractProcedure {
