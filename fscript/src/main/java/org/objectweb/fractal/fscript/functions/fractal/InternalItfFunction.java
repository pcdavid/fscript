...
/**
 * Tests whether an interface is internal or external. This procedure takes exactly one
 * argument, which must be an interface node, are returns <code>true</code> if the
 * corresponding component interface is an internal interface, and <code>false</code> if
 * it is an external interface.
 * 
 * @author Pierre-Charles David <pcdavid@gmail.com>
 */
public class InternalItfFunction extends AbstractProcedure {
