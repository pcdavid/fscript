...
/**
 * This function returns the current state of a component. It takes a single component
 * node as argument and return the name of the state the component is currently in (e.g.
 * <code>"STARTED"</code> or <code>"STOPPED"</code>).
 * 
 * @author Pierre-Charles David <pcdavid@gmail.com>
 */
public class StateFunction extends AbstractProcedure {
