...
/**
 * Implements the <code>rmi_bind()</code> action, which exports a Fractal component
 * reference in the current Fractal RMI registry. This is a custom action which can not be
...
public class RmiBindAction extends AbstractFractalProcedure {
    ...
    public Signature getSignature() {
        return new Signature(VOID_TYPE, STRING, model.getNodeKind("component"));
    }
    ...
    public Object apply(List<Object> args, Context ctx) throws ScriptExecutionError {
        ...
        ns.rebind(name, node.getComponent());
        return null;
    }
}
