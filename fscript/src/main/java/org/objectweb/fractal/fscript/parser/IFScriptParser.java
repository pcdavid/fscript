...
/**
 * Parses full FScript programs (procedure definitions) or single statements into abstract syntax
 * trees.
 * 
 * @author Pierre-Charles David
 */
public interface IFScriptParser extends IFPathParser {
    ASTNode parseStatement(Reader source) throws InvalidScriptException;
    List<UserProcedure> parseDefinitions(Reader source) throws InvalidScriptException;
}
