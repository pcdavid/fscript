...
/**
 * Implements the <code>ends-with()</code> function to test for string suffixes.
 * 
 * @author Pierre-Charles David
 */
@Immutable
public class EndsWithFunction extends AbstractProcedure {
    public EndsWithFunction() {
        super("ends-with", true, new Type[] { STRING, STRING }, BOOLEAN);
    }
