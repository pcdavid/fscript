...
/**
 * Implements the <code>&gt;=</code> binary operator for number comparison.
 * 
 * @author Pierre-Charles David
 */
@Immutable
public class GreaterThanOrEqualFunction extends AbstractProcedure {
    public GreaterThanOrEqualFunction() {
        super(">=", true, new Type[] { NUMBER, NUMBER }, BOOLEAN);
    }

    public Object apply(List<Object> args, Context ctx) throws ScriptExecutionError {
        double n0 = ((Number) args.get(0)).doubleValue();
        double n1 = ((Number) args.get(1)).doubleValue();
        return n0 >= n1;
    }
}
