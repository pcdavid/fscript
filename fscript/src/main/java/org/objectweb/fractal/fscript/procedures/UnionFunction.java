...
/**
 * Implements the <code>union()</code> function which computes the union of its two
 * node-set arguments.
 * 
...
public class UnionFunction extends AbstractProcedure {
    public UnionFunction() {
        super("union", true, new Type[] { ANY_NODE_SET_TYPE, ANY_NODE_SET_TYPE }, ANY_NODE_SET_TYPE);
    }
