...
/**
 * Wraps <code>ContentController#addFcSubComponent(Component)</code> into an atomic
 * action.
 * 
 * @author Pierre-Charles David <pcdavid@gmail.com>
 */
public class AddReconfiguration extends AbstractReconfiguration {
    private Component composite;

    private Component subcomponent;

    public AddReconfiguration(Component composite, Component subcomponent) {
    ...
    protected Object apply(Transaction tx) throws NoSuchInterfaceException,
        ...
        if (!Arrays.asList(children).contains(subcomponent)) {
            ...
            tx.registerUndo(new RemoveReconfiguration(composite, subcomponent));
        }
        return null;
    }
}
